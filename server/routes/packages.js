...
// GET all active packages (for homepage display)
...
router.post("/", async (req, res) => {
  try {
    const { title, price, currency, billingCycle, description, features, badge, order } = req.body;
    const pkg = new Package({ title, price, currency, billingCycle, description, features, badge, order });
    await pkg.save();
