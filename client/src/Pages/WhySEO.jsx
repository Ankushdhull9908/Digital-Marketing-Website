    ...
    <div className="min-h-screen bg-base-100 font-montserrat text-base-content overflow-x-hidden">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-3xl md:text-5xl font-black mb-4"><span className="text-[#3D7E8C]"> The Impact</span> <span className="text-[#F39221]"> of Ranking</span>  </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((b, i) => (
            <motion.div
              ...
              className="p-10 bg-base-100 border border-base-300 rounded-[2rem] shadow-sm"
            >
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mb-6 text-emerald-400 bg-[#3D7E8C]/10">
                {b.icon}
              </div>
              <h4 className="text-xl font-black mb-4 text-[#F39221]">{b.title}</h4>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          {/* Left Side: Features */}
          <div>
            <h2 className="text-4xl font-black mb-8">Why Choose <span className="text-[#3D7E8C]">Web</span><span className="text-[#F39221]">Tech?</span></h2>
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex gap-4">
                  ...
                  <div>
                    <h5 className="font-black text-[#F39221] text-lg">{item.t}</h5>
